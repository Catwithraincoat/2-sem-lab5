    ...
    public void execution(CollectionManager collectionManager, BufferedReader input) throws IOException {
        ...
        while (error){
            try{
                ...
                if (floatCoordinatex > 894){ throw new NumberFormatException(); }
                String coordinateY = input.readLine();
                Float floatCoordinatey = Float.valueOf(coordinateY);
                if (floatCoordinatey < -94){ throw new NumberFormatException(); }
        ...
        while (error) {
            try {
                ...
                if (manufactureCost <= 0){throw new NumberFormatException();}
